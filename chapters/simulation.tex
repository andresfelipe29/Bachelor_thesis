...
\begin{figure}[H]
  \centering
  \includegraphics[width=.98\textwidth]{G4_simulations/PScint_photon_count/PScint_scint_size.pdf}
...
\begin{figure}[H]
  ...
  \medskip
  \begin{subfigure}[t]{0.48\textwidth}
    \includegraphics[width=\textwidth]{G4_simulations/ang_dist/PScint_ang_dist_cylinder_run0_nt_Event_energy_spectra.pdf}
  ...
  \hfill
  \begin{subfigure}[t]{0.48\textwidth}
    \includegraphics[width=\textwidth]{G4_simulations/ang_dist/PScint_ang_dist_cylinder_run0_nt_Event_photon_count.pdf}
