...
\usepackage{pdfpages} %-------include pdf as full page-------%
...
\renewcommand{\director}{Prof. Fernando Cristancho Mejia}
\renewcommand{\codirector}{Prof. Spencer Nicholas Gaelan Axani}
...
{\Large The Road goes ever on and on,\\
...
\\[1em]
\sede., $1^{\text{ero}}$ de Julio del 2024
\\[6em]
\rule{6cm}{0.5pt}\\
\studentname
}
...
%\include{frontmatter/Abreviaturas}
\include{frontmatter/ResumenAbstract}
\tableofcontents 
...
\include{chapters/physical_aspects}
\include{chapters/detector_description}
\include{chapters/detection_methods}
...
\begin{appendix}
\include{appendixes/RP_code}%
\include{appendixes/Links}%
\end{appendix}
